...
import type { Pipeline, ResourceLink, Sample, Stage } from '@/types/pipeline';
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-[2fr_1fr]">
          <Card elevation="md">
            ...
            <div className="mt-4">
              ...
              <ul className="mt-2 flex flex-wrap gap-2">
                {pipeline.profile.keyConcepts.map((concept: string) => (
                  <li key={concept}>
          ...
          <Card elevation="md">
            ...
            <ul className="mt-3 space-y-2 text-sm text-zinc-600 dark:text-zinc-300">
              {pipeline.highlights.map((item: string) => (
            ...
            <div className="mt-4">
              ...
              <ul className="mt-2 space-y-1 text-sm text-zinc-600 dark:text-zinc-300">
                {pipeline.profile.recommendedAudiences.map((aud: string) => (
                  <li key={aud}>{aud}</li>
                ))}
              </ul>
            </div>
            <div className="mt-4">
              ...
              <div className="mt-2 flex flex-wrap gap-2">
                {pipeline.samples.slice(0, 8).map((sample: Sample) => (
        ...
        {pipeline.resources.length > 0 ? (
          <section className="mt-10">
            ...
            <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
              {pipeline.resources.map((resource: ResourceLink) => (
